<script lang="ts">
  ...
  import { fetchEventById, type Event } from "$lib/services/api";
                  ...
                  <div class="space-y-2">
                    <div class="flex justify-between text-sm">
                      ...
                      <span class="text-primary font-bold"
                        >{event.max_attendees - parseInt(event.attendees)} left</span
                      >
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        <span
                          ...
                          >{event.organizer_name?.charAt(0) || 'O'}</span
                        >
                      </div>
                    </div>
                    <div>
...
{:else}
  ...
  >
    ...
    <Button variant="link" onclick={goBack} disabled={false} class="mt-4"
