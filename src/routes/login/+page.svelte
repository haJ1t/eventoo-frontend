      ...
      <form on:submit|preventDefault={handleLogin} class="flex flex-col gap-7">
        ...
        <div class="grid gap-2">
          ...
          <div class="flex items-center gap-4 mt-1">
            ...
            >
              <input type="checkbox" bind:checked={showPassword} /> Show
              password
              <input type="checkbox" bind:checked={keepSignedIn} /> Keep me signed
              in
            </label>
          </div>
          {#if error}
        ...
        <Button
          variant="outline"
          class="w-full modern-btn-google"
          type="button"
        ...
        >
          <svg
            ...
            ><g
              ...
              /><path
                fill="#34A853"
                d="M46.1 24.55c0-1.64-.15-3.22-.43-4.74H24v9.01h12.44c-.54 2.9-2.18 5.36-4.64 7.01l7.19 5.6C43.98 37.13 46.1 31.3 46.1 24.55z"
              /><path
                fill="#FBBC05"
                d="M10.67 28.09a14.5 14.5 0 0 1 0-8.18l-7.98-6.2A23.94 23.94 0 0 0 0 24c0 3.77.9 7.34 2.69 10.44l7.98-6.2z"
              /><path
                fill="#EA4335"
                d="M24 48c6.18 0 11.36-2.05 15.15-5.57l-7.19-5.6c-2.01 1.35-4.59 2.16-7.96 2.16-6.38 0-11.87-3.63-14.33-8.94l-7.98 6.2C6.73 42.52 14.82 48 24 48z"
